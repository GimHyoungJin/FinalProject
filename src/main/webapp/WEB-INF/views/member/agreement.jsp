...
<head>
  ...
  <link href="<c:url value='/css/member/agreement.css' />" rel="stylesheet" type="text/css">
</head>
<body>
<div class="container">
  ...
  <h3>* 회원약관 *</h3>
  <form action="<c:url value='/member/agreement' />" method="post" onsubmit="return send()">
    <!-- 약관 텍스트 영역 -->
    <div class="form-group">
      <textarea class="agreement-textbox" readonly>
...
② 제1항에 의한 서비스 중단의 경우에는 "Community"은 제7조 제2항에서 정한 방법으로 이용자에게 통지합니다. 다만, "Community"이 통제할 수 없는 사유로 인한 서비스의 중단(시스템 관리자의 고의, 과실이 없는 디스크 장애, 시스 템 다운 등)으로 인하여 사전 통지가 불가능한 경우에는 그러하지 아니합니다. 
