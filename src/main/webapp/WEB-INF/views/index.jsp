    ...
    <div class="movie-poster">
        <c:forEach var="movie" items="${movies}" varStatus="status">
            <div class="poster-container">
                <img src="<c:url value='${movie.poster_url}' />" alt="${movie.movie_title}" width="220px" height="330px">
                <div class="number">${status.index + 1}</div>
                <div class="section-buttons">
                    <a class="btn btn-detail" href="<c:url value='/movie/moviedetail?id=${movie.movie_id}' />">상세정보</a>
