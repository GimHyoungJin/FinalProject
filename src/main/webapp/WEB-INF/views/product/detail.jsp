...
<script>
    function product_update() {
        var proDetailCode = document.querySelector("input[name='pro_detail_code']").value;
        if (!proDetailCode) {
            alert("Product detail code is missing");
...
<form name="productfrm" id="productfrm" method="post" action="/product/update" enctype="multipart/form-data">
    ...
    <table class="table table-hover">
        <tbody style="text-align: left;">
            ...
            <tr>
                <td>상품설명</td>
                <td><textarea rows="5" name="pro_detail" class="form-control" required>${product.pro_detail}</textarea></td>
            </tr>
            <tr>
                <td>상품사진</td>
                <td>
            ...
            <tr>
                <td>재고 수량</td>
                <td><input type="number" name="pro_stock" value="${product.pro_stock}" class="form-control" required></td>
            </tr>
            <tr>
                <td>상품 수량</td>
                <td>
